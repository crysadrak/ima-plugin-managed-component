...
/**
 * Generates the {@code AbstractManagedComponent} class by extending the
 * provided IMA {@code ima/page/AbstractComponent} class.
 *
 * @param {function(new: AbstractComponent, Object, Object)} AbstractComponent
 *        The IMA's {@code ima/page/AbstractComponent} class.
 * @return {function(new: AbstractManagedComponent, Object, Object)} The
 *         generated abstract managed component.
 */
export default (AbstractComponent) => {
	/**
	 * Abstract UI component that automatically manages the registered DOM,
	 * event bus and dispatcher event listeners, timeouts and intervals. The
	 * component automatically deregisters all of these right before the
	 * component unmounts from the DOM.
	 *
	 * @abstract
	 */
	return class AbstractManagedComponent extends AbstractComponent {
		/**
		...
		/**
		 * Replacement of the {@linkcode componentWillUnmount()} method that
		 * can be overridden by the component extending this class.
		 */
		onBeforeUnmount() {}
		 ...
		 * registered event bus, dispatcher and DOM event listeners, all
		 * pending timeouts and active intervals registered by this component.
		 *
		 * @override
		 */
